...
const Profile = () => {
  ...
  <div className="w-full md:w-1/5 md:mr-6">
    <div className="h-30 flex justify-left md:justify-center mb-5 md:mb-0">
      <img
  ...
  <div className="w-full md:w-4/5">
    <div className="flex flex-col md:flex-row md:justify-between gap-4 md:gap-12">
      <div className="flex flex-col">
        ...
        <p className="body-medium text-light-3 mt-1">@{user?.username}</p>
      </div>
      <Link to={`/update-profile/${user?.id}`} className={`${user.id !== uid && "hidden"}`}>
    ...
    <div className="mt-3 md:mt-7">
      ...
      <p className="mt-4 md:mt-6">
        ...
        <br /> ✨ "In every walk with nature, one receives far more than
        he seeks." - brian-ahsan
      </p>
    </div>
  </div>
</div>
